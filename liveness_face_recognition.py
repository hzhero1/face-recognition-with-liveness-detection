...
while True:
	...
	for i in range(0, detections.shape[2]):
		...
		if confidence > args["confidence"]:
			...
			if rec_mod == 0:
				...
				encodings = face_recognition.face_encodings(frame, [(startY, endX, endY, startX)])
	...
	cv2.putText(frame, "Face recognition running", (25, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 2)
	cv2.putText(frame, "Liveness detection: {}".format(status_l), (25, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 2)
	cv2.putText(frame, "Blink detection: {}".format(status_b), (25, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 2)
