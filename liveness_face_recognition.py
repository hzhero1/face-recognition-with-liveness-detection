...
while True:
	...
	if rec_mod == 0:
		...
		for i in range(0, detections.shape[2]):
			...
			if confidence > args["confidence"]:
				...
				if label == "Real":
					...
					cv2.putText(frame, label, (startX, startY - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
					cv2.rectangle(frame, (startX, startY), (endX, endY), (0, 255, 0), 2)
		cv2.putText(frame, "Liveness detection: ON", (25, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 2)
		...
		cv2.putText(frame, "Liveness detection: OFF", (25, 80), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 2)

	cv2.putText(frame, "Face recognition running", (25, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (255, 0, 0), 2)
